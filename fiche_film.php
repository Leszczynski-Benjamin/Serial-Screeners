            ...
            <img class="affiche" src="./img/films/pulp_fiction.jpg" alt="affiche">
                ...
                <h4 class="box">
                    ...
                    <div class="container1">
                        <div class="left1">
                            <h5 class="cast">Réalisateur(s): <?= $data->realisateur?></h5>
                            <h5 class="cast">Acteurs principaux: <?= $data->acteurs_principaux?></h5>
                        </div>
                        <div class="right1">
                            <h5 class="infos">Genre: <?= $data->genre?></h5>            
                            <h5 class="infos">Date de sortie: <?= $data->date_de_sortie_france?>                              
                            <h5 class="infos">Durée: <?= $data->duree_en_minutes?> minutes                              
                            </h5>          
                        </div>
                    </div>
